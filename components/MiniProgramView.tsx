...
import MiniProgramMerchStore from './MiniProgramMerchStore';
...
const MiniProgramView: React.FC<MiniProgramViewProps> = ({ resetTrigger }) => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            {filteredMerch.map(ticket => {
                                // Lookup product for price/points calculation
                                ...
                                const isPoints = ticket.redeemMethod === 'POINTS';
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col mt-1 space-y-0.5">
                                                <div className="text-xs text-gray-500 flex justify-between">
                                                    <span>数量: <span className="font-bold text-gray-800">x{ticket.quantity || 1}</span></span>
                                                    {totalCost && (
                                                        <span className={`font-bold ${isPoints ? 'text-purple-600' : 'text-gray-900'}`}>
                                                            {isPoints ? '消费' : '实付'}: {totalCost}
                                                        </span>
                                                    )}
                                                </div>
  ...
  return (
    <div className="flex flex-col h-full bg-white relative overflow-hidden">
      ...
      {showStore && (
        <MiniProgramMerchStore
          products={products}
          userMerchTickets={userMerchTickets}
          ...
          onShowTicketQRCode={(ticket) => setShowTicketQRCode(ticket)}
        />
      )}
