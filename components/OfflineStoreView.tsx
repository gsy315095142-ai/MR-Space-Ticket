...
const DEFAULT_PRODUCTS: MerchItem[] = [
  { id: 'p1', name: 'LUMI魔法师徽章', image: 'https://images.unsplash.com/photo-1590543789988-66236b2f689e?w=400&h=400&fit=crop', points: 100, price: 29, stock: 50 },
      ...
      <div className="flex-1 flex flex-col justify-start px-4 overflow-y-auto no-scrollbar space-y-20">
        {shelfChunks.length > 0 ? shelfChunks.map((chunk, shelfIdx) => (
          ...
          <div className="flex flex-col items-center justify-center py-40 opacity-20">
            <Boxes size={100} className="text-white mb-4" />
            <p className="text-white font-bold text-xl uppercase tracking-widest">货架空空如也</p>
          </div>
        )}
      </div>
            ...
            <div className="p-12">
               ...
               <div className="space-y-8">
                  ...
                  <button 
                    ...
                    className={`w-full text-white font-black py-6 rounded-[2rem] text-xl shadow-2xl active:scale-[0.98] transition-all flex items-center justify-center gap-3 ${!selectedProduct.stock || selectedProduct.stock <= 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-stone-900 shadow-stone-400/50 hover:bg-stone-800'}`}
                  >
